...
def add_args(parser):
    ...
    parser.add_argument("--ego_number", type=int, default=10, help="Sampled ego nodes")

    parser.add_argument("--hop_number", type=int, default=2, help="Number of hops")
...
def load_data(args, dataset_name):
    ...
    sgs, num_cats = get_data(
        args.data_dir, args.dataset, args.type_network, args.ego_number, args.hop_number
    )
